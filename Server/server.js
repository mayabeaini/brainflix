...
app.route('/videos')
    ...
    sideVideo.push(video);
    res.json(video);
    mainVideo.push(smallId);
    res.json(smallId)
...
app.route('/videos/:id')
    .get( (req, res)=>{
        ...
        const picked = mainVideo.find(o => o.id === id);
        res.json(picked)
    })

app.route('/videos/:id/comments')
    .post((req,res)=>{
        const id = req.params.id
        const picked = mainVideo.find(o => o.id === id);
        res.json(picked.comments)
